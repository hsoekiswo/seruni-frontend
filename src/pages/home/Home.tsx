            ...
            <div className="max-w-[1000px] w-full my-2 px-4 sm:px-6">
                <div className="flex flex-col justify-center items-center">
                    <div className="flex flex-wrap items-end justify-center text-center">
                        ...
                        <h2 className="font-thin pb-2 text-lg sm:text-xl md:text-2xl">A Guide to Kinesiology</h2>
                    </div>
                    <h2 className="font-thin pb-2 text-lg sm:text-xl md:text-2xl">By Seruni Sekarpuri</h2>
                </div>
